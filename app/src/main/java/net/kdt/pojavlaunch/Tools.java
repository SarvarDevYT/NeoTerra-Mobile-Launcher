...
public final class Tools {
    ...
    public static String APP_NAME = "NeoTerra Launcher";
    ...
    public static String[] getMinecraftClientArgs(MinecraftAccount profile, JMinecraftVersionList.Version versionInfo, File gameDir) {
        ...
        if(sConnectNeoTerraServer) {
            if(versionName != null && (versionName.contains("1.20") || versionName.contains("1.21"))) {
                mcArguments += " --quickPlayMultiplayer " + NEOTERRA_SERVER_IP + ":" + NEOTERRA_SERVER_PORT;
            } else {
                mcArguments += " --server " + NEOTERRA_SERVER_IP + " --port " + NEOTERRA_SERVER_PORT;
            }
        }
